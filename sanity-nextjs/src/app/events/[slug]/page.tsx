...
// Used to generate aka build a URL for the images retrieved
    ...
    <main className="container mx-auto grid gap-12 p-12">
      ...
      <div className="grid items-top gap-12 sm:grid-cols-2">
        ...
        <div className="flex flex-col justify-center space-y-4">
          ...
          {tickets && (
            <a
              className="flex items-center justify-center rounded-md bg-blue-500 hover:bg-blue-700 p-4 text-white"
              href={tickets}
            >
              Buy Tickets
            </a>
